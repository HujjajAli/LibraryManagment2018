				...
				<div class="panel panel-danger">
					...
					<div class="panel-body">
						...
						<div class="form-group row">
							...
							<div class="col-md-9">
								<select  name="publishercountry" class="form-control" required>
						...
						<div class="form-group row">
							<div class="col-md-3">
								<label>Foundin Date</label>
							</div>
							<div class="col-md-9">
								<input type="date" name="foundingdate"  class="form-control" placeholder="Choose Date..." required>
							</div>
						</div>
						<div class="form-group row">
							<div class="col-md-4">
							...
							<div class="col-md-4">
								<input type="submit" name="action" class="form-control btn-success" value="Save Publisher">
							</div>
							<div class="col-md-4">
					...
					<div class="panel-footer">
						<div class="alert alert-success text-uppercase fade in">
							<a href="#" class="close" data-dismiss="alert" area-label="close">&times;</a>${pubmsg}
						</div>
					</div>
				</div>
			</form>
